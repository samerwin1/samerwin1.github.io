...
| **Solution**                                                                                                                                                                                      | **Pros**                                                                                                                                    | **Cons**                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![](2N7000(MOSFET).png){style="width:25%; height:25%;"}<br>Option 1.<br> 2N7000 <br>$0.21/each<br>[link to product](https://www.digikey.com/en/products/detail/diotec-semiconductor/2N7000/13164314)                 | \*Least expensive<br>\* Current rating meets goal<br>\* Easy to source                                             | \* Lower current rating than other options<br>\* Higher Rds(on)<br>\* Lower power dissipation |
| ![](IRLZ44NPBF(MOSFET).png){style="width:25%; height:25%;"}<br>Option 2.<br> IRLZ44NPBF <br> $1.53/each <br> [Link to product](https://www.digikey.com/en/products/detail/infineon-technologies/IRLZ44NPBF/811808) | \* Affordable <br>\* Very high current rating<br>\* High power dissipation | \* More expensive than other options<br>\* High Input Capacitance                                                         |
| ![](FQP13N06L(MOSFET).png){style="width:25%; height:25%;"}<br>Option 2.<br> FQP13N06L <br> $0.68/each <br> [Link to product](https://www.digikey.com/en/products/detail/rochester-electronics-llc/FQP13N06L/13455336) | \* Inexpensive<br>\* Most balanced performance vs cost<br>\* Mid-grade current rating | \* Only sold in bulk<br>\* High shipping fee<br>\* Higher input capacitance                                                       |
...
| **Solution**                                                                                                                                                                                      | **Pros**                                                                                                                                    | **Cons**                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![](LM7805(Regulator).png){style="width:25%; height:25%;"}<br>Option 1.<br> LM7805 Linear Voltage Regulator<br>$0.33/each<br>[link to product](https://www.digikey.com/en/products/detail/taejin/lm7805t/22237260)                 | \*Affordable<br>\* Fits project goals<br>\* Already provided                                             | \* Higher voltage dropout<br>\* Lower max current<br>\* Not optimized for efficiency |
| ![](LM1085IT-5.0(Regulator).png){style="width:25%; height:25%;"}<br>Option 2.<br> LM1085IT-5.0 Linear Voltage Regulator <br> $2.13/each <br> [Link to product](https://www.digikey.com/en/products/detail/texas-instruments/LM1085IT-5-0-NOPB/363564) | \* Higher current capability <br>\* Low voltage dropout<br>\* Better regulation characteristics | \* Expensive<br>\* Poor efficiency                                                         |
| ![](LM2941T(Regulator).png){style="width:25%; height:25%;"}<br>Option 2.<br> LM2941T Linear Voltage Regulator <br> $1.72/each <br> [Link to product](https://www.digikey.com/en/products/detail/texas-instruments/LM2941T-NOPB/148144) | \* Lowest voltage dropout<br>\* Low noise<br>\* Ranging output voltage| \* Expensive<br>\* Lowest current rating                                                      |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **IR Emitter**                 | ![](TSAL6200(IR%20Emitter).png){style="width:25%; height:25%;"}<br>Option 2.<br>TSAL6200 IR Emitting Diode <br> $0.49/each <br> [Link to product](https://www.digikey.com/en/products/detail/vishay-semiconductor-opto-division/TSAL6200/1681339?s=N4IgTCBcDaIC4GcCGAbAbGADJkBdAvkA)                                             |
| **IR Detector**                | ![](BPV23NF(Photodiode).png){style="width:25%; height:25%;"}<br>Option 2.<br>BPV23NF Silicon PIN Photodiode<br> $1.08/each <br> [Link to product](https://www.digikey.com/en/products/detail/vishay-semiconductor-opto-division/BPV23NF/1681143)                                             |
| **Operational Amplifier**      | ![](MCP6022(OpAmp).png){style="width:25%; height:25%;"}<br>Option 2.<br> MCP6022 <br> $1.86/each <br> [Link to product](https://www.digikey.com/en/products/detail/microchip-technology/MCP6022-I-P/417828)                                             |
| **MOSFET**                     | ![](IRLZ44NPBF(MOSFET).png){style="width:25%; height:25%;"}<br>Option 2.<br> IRLZ44NPBF <br> $1.53/each <br> [Link to product](https://www.digikey.com/en/products/detail/infineon-technologies/IRLZ44NPBF/811808)                                             |
| **Voltage Regulator**          | ![](LM7805(Regulator).png){style="width:25%; height:25%;"}<br>Option 1.<br> LM7805 Linear Voltage Regulator<br>$0.33/each<br>[link to product](https://www.digikey.com/en/products/detail/taejin/lm7805t/22237260)                                             |
